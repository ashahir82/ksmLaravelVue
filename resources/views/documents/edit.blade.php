            ...
            <div class="justify-center">
                ...
                <form action="{{ route('documents.update', $document) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $document->name) }}">
                            @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama_penulis') is-invalid @enderror" id="nama_penulis" name="nama_penulis" value="{{ old('nama_penulis', $document->nama_penulis) }}">
                            @error('nama_penulis')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control @error('tarikh_diterbitkan') is-invalid @enderror" id="tarikh_diterbitkan"
                                name="tarikh_diterbitkan" value="{{ old('tarikh_diterbitkan', $document->tarikh_diterbitkan) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama_pelulus') is-invalid @enderror" id="nama_pelulus" name="nama_pelulus" value="{{ old('nama_pelulus', $document->nama_pelulus) }}">
                            @error('nama_pelulus')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control @error('tarikh_disahkan') is-invalid @enderror" id="tarikh_disahkan" name="tarikh_disahkan" value="{{ old('tarikh_disahkan', $document->tarikh_disahkan) }}">
